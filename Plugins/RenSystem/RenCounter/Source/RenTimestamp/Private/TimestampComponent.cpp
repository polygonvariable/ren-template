...
ETimestampStatus UTimestampComponent::GetStatus() const
{
	...
	return TimestampSubsystemPtr->GetStatus(ContainerId, TimestampId);
}
...
bool UTimestampComponent::AddTimestamp(bool bForceAdd)
{
	...
	return TimestampSubsystemPtr->AddTimestamp(ContainerId, TimestampId, bForceAdd);
}

...
void FRWeatherEdModule::ShutdownModule()
{
...
void FRWeatherEdModule::SetIconAndThumbnail(FString ClassName, FString ImagePath)
{
...
IMPLEMENT_MODULE(FRWeatherEdModule, RWeatherEd)

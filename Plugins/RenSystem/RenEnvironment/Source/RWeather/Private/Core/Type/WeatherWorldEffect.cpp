...
void FWeatherWorldEffect::Execute(UActorComponent* Component, bool bIsAdded)
{
    SetAlpha(Component, bIsAdded ? 1.0f : 0.0f);
}

void FWeatherWorldEffect::SetAlpha(UActorComponent* Component, float NewAlpha)
{
...
void FWeatherWorldEffect_MoveComponent::OnApplyChange(UActorComponent* Component, float OldAlpha, float NewAlpha)
{

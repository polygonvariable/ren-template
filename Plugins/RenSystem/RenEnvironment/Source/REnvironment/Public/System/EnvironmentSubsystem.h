...
public:
	...
	RENVIRONMENT_API void AddProfile(const FGuid& LatentId, const FPrimaryAssetId& AssetId, int Priority);

	UFUNCTION(BlueprintCallable)
	RENVIRONMENT_API bool RemoveProfile(const FGuid& LatentId, const FPrimaryAssetId& AssetId, int Priority);

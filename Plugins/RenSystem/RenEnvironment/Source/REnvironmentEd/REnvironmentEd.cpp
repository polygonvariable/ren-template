...
#define LOCTEXT_NAMESPACE "FREnvironmentEdModule"

void FREnvironmentEdModule::StartupModule()
{
...
void FREnvironmentEdModule::ShutdownModule()
{
...
void FREnvironmentEdModule::SetIconAndThumbnail(FString ClassName, FString ImagePath)
{
...
IMPLEMENT_MODULE(FREnvironmentEdModule, REnvironmentEd)

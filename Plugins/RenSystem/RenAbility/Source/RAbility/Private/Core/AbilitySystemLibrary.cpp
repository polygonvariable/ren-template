...
// Parent Header
#include "Core/AbilitySystemLibrary.h"
...
FGameplayTag UAbilitySystemLibrary::GetFirstMatchingGameplayTag(const FGameplayTagContainer& Container, FGameplayTag TagToMatch)
{
	FGameplayTag Result;

...
// Parent Header
#include "Widget/EquipmentWeaponItemUI.h"

// Engine Headers
#include "Components/TextBlock.h"

// Project Headers
#include "System/Controller/EquipmentController_Weapon.h"
...
void UEquipmentWeaponItemUI::RegisterEquipmentController()
{
	...
	UEquipmentController_ProjectileWeapon* Weapon = GetEquipmentController<UEquipmentController_ProjectileWeapon>();
	if (IsValid(Weapon))
	{

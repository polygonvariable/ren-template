...
public:
	...
	RENINTERACT_API virtual void Interacted() = 0;

	RENINTERACT_API virtual FOnInteracted& GetOnInteracted() = 0;
	RENINTERACT_API virtual FOnInteractUpdated& GetOnInteractUpdated() = 0;

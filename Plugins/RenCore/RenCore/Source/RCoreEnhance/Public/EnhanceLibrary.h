...
public:
    ...
    RCOREENHANCE_API static int CalculateRequiredItemsForRankCap(int CurrentLevel, int CurrentXp, int Rank, int Points, int XpInterval, int LevelInterval);
	...
	RCOREENHANCE_API static bool CanRankUp(int Xp, int Level, int Rank, int LevelInterval);

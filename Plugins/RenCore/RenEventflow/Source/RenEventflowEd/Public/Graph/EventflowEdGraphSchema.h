...
UCLASS()
class RENEVENTFLOWED_API UEventflowEdGraphSchema : public UEdGraphSchema
{
...
USTRUCT()
struct RENEVENTFLOWED_API FEventflowEdGraphSchemaAction : public FEdGraphSchemaAction
{
